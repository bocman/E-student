  ...
  <body>
     <?php
       if (empty($_COOKIE['eStudenUser']) ){
	   	   header("Location: http://localhost/estudent/main.php");
           die();
	   }
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" role="navigation">
          ...
          <br>
            ...
            if (empty($_COOKIE['eStudenUser']) ){
			?>
                <a href="" class="list-group-item active">Povezave</a>
                <a href="http://www.fri.uni-lj.si/si/novice_in_dogodki/aktivne/default.html" class="list-group-item">Novice in dogodki</a>
                <a href="#" class="list-group-item">Informacije o študiju</a>
                <a href="http://www.fri.uni-lj.si/" class="list-group-item">Kontakti</a>
                <a href="https://www.facebook.com/ulfri?fref=ts" class="list-group-item">FRI na Facebooku</a>
